  ...
  return _regenerator().w(function (_context) {
    while (1) switch (_context.n) {
      case 0:
        ...
        _t = console;
        _context.n = 1;
        return lice.fetchComposer('laravel/framework', 'latest');
      case 1:
        _t.log.call(_t, "Laravel:", _context.v);
        _t2 = console;
        _context.n = 2;
        return lice.fetchComposer('guzzlehttp/guzzle');
      case 2:
        _t2.log.call(_t2, "Guzzle:", _context.v);
        console.log('----------------------- Pub.dev');
      case 3:
        return _context.a(2);
    }
