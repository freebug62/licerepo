  ...
  return _regenerator().w(function (_context) {
    while (1) switch (_context.n) {
      case 0:
        ...
        _t = console;
        _context.n = 1;
        return lice.fetchNpm('react', 'latest');
      case 1:
        _t.log.call(_t, "React:", _context.v);
        _t2 = console;
        _context.n = 2;
        return lice.fetchNpm('axios', '1.13.4');
      case 2:
        _t2.log.call(_t2, "Axios:", _context.v);
        _t3 = console;
        _context.n = 3;
        return lice.fetchYaml('provider');
      case 3:
        _t3.log.call(_t3, "Provider:", _context.v);
        _t4 = console;
        _context.n = 4;
        return lice.fetchYaml('http');
      case 4:
        _t4.log.call(_t4, "http:", _context.v);
      case 5:
        return _context.a(2);
    }
  }, _callee);
